...
export default function ProfileCard() {
    ...
    const handleLogout = async () => {
        // await logout(); // if you have logout hook
        router.push("/login");
    };
            ...
            >
                    ...
                    <TextField
                        ...
                        sx={{
                            "& .MuiOutlinedInput-root": {
                                borderRadius: "16px",
                                "&.Mui-focused fieldset": { borderColor: "#097C44" },
                            },
                            "& .MuiOutlinedInput-notchedOutline": { borderColor: "#ccc" },
                            "&:hover .MuiOutlinedInput-notchedOutline": { borderColor: "#097C44" },
                        }}
                    />
                </Box>
                ...
                <Button
                    ...
                    sx={{
                        ...
                        borderRadius: "12px",
                        px: "16px",
                        backgroundColor: "rgb(167, 248, 208)",
                        color: "rgba(9, 124, 68, 1)",
                        fontWeight: 600,
                        textTransform: "none",
                        boxShadow: "none",
                        "&:hover": { backgroundColor: "rgb(5, 238, 121)", boxShadow: "none" },
                    }}
                >
                ...
                <Grid container>
                    {statsData.map((stat, index) => (
                        ...
                        >
                            <Typography
                                variant="body2"
                                sx={{ fontWeight: 600, fontSize: '16px', color: "rgba(16, 24, 40, 0.6)" }}
                            >
                                {stat.label}
                            </Typography>
                            <Typography
                                variant="h6"
                                sx={{ fontWeight: 600, fontSize: '32px', color: "rgba(16, 24, 40, 1)" }}
                            >
                                {stat.value}
                            </Typography>
                        </Grid>
